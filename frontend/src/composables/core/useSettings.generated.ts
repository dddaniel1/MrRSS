...
export function generateInitialSettings(): SettingsData {
  return {
    ...
    alipan_backup_filename: settingsDefaults.alipan_backup_filename,
    alipan_backup_folder: settingsDefaults.alipan_backup_folder,
    alipan_client_id: settingsDefaults.alipan_client_id,
    alipan_client_secret: settingsDefaults.alipan_client_secret,
    alipan_enabled: settingsDefaults.alipan_enabled,
    alipan_last_backup_time: settingsDefaults.alipan_last_backup_time,
    alipan_last_restore_time: settingsDefaults.alipan_last_restore_time,
    alipan_refresh_token: settingsDefaults.alipan_refresh_token,
    article_layout_mode: settingsDefaults.article_layout_mode,
    ...
    eagle_api_url: settingsDefaults.eagle_api_url,
    eagle_enabled: settingsDefaults.eagle_enabled,
    eagle_folder_id: settingsDefaults.eagle_folder_id,
    eagle_folder_name: settingsDefaults.eagle_folder_name,
    eagle_include_feed_tag: settingsDefaults.eagle_include_feed_tag,
    eagle_max_batch_size: settingsDefaults.eagle_max_batch_size,
    eagle_name_template: settingsDefaults.eagle_name_template,
    eagle_tags: settingsDefaults.eagle_tags,
    eagle_timeout_seconds: settingsDefaults.eagle_timeout_seconds,
    ...
    webdav_enabled: settingsDefaults.webdav_enabled,
    webdav_last_sync_time: settingsDefaults.webdav_last_sync_time,
    webdav_password: settingsDefaults.webdav_password,
    webdav_remote_path: settingsDefaults.webdav_remote_path,
    webdav_url: settingsDefaults.webdav_url,
    webdav_username: settingsDefaults.webdav_username,
...
export function parseSettingsData(data: Record<string, string>): SettingsData {
  return {
    ...
    alipan_backup_filename: data.alipan_backup_filename || settingsDefaults.alipan_backup_filename,
    alipan_backup_folder: data.alipan_backup_folder || settingsDefaults.alipan_backup_folder,
    alipan_client_id: data.alipan_client_id || settingsDefaults.alipan_client_id,
    alipan_client_secret: data.alipan_client_secret || settingsDefaults.alipan_client_secret,
    alipan_enabled: data.alipan_enabled === 'true',
    alipan_last_backup_time:
      data.alipan_last_backup_time || settingsDefaults.alipan_last_backup_time,
    alipan_last_restore_time:
      data.alipan_last_restore_time || settingsDefaults.alipan_last_restore_time,
    alipan_refresh_token: data.alipan_refresh_token || settingsDefaults.alipan_refresh_token,
    article_layout_mode: data.article_layout_mode || settingsDefaults.article_layout_mode,
    ...
    eagle_api_url: data.eagle_api_url || settingsDefaults.eagle_api_url,
    eagle_enabled: data.eagle_enabled === 'true',
    eagle_folder_id: data.eagle_folder_id || settingsDefaults.eagle_folder_id,
    eagle_folder_name: data.eagle_folder_name || settingsDefaults.eagle_folder_name,
    eagle_include_feed_tag: data.eagle_include_feed_tag === 'true',
    eagle_max_batch_size:
      parseInt(data.eagle_max_batch_size) || settingsDefaults.eagle_max_batch_size,
    eagle_name_template: data.eagle_name_template || settingsDefaults.eagle_name_template,
    eagle_tags: data.eagle_tags || settingsDefaults.eagle_tags,
    eagle_timeout_seconds:
      parseInt(data.eagle_timeout_seconds) || settingsDefaults.eagle_timeout_seconds,
    ...
    webdav_enabled: data.webdav_enabled === 'true',
    webdav_last_sync_time: data.webdav_last_sync_time || settingsDefaults.webdav_last_sync_time,
    webdav_password: data.webdav_password || settingsDefaults.webdav_password,
    webdav_remote_path: data.webdav_remote_path || settingsDefaults.webdav_remote_path,
    webdav_url: data.webdav_url || settingsDefaults.webdav_url,
    webdav_username: data.webdav_username || settingsDefaults.webdav_username,
...
export function buildAutoSavePayload(settingsRef: Ref<SettingsData>): Record<string, string> {
  return {
    ...
    alipan_backup_filename:
      settingsRef.value.alipan_backup_filename ?? settingsDefaults.alipan_backup_filename,
    alipan_backup_folder:
      settingsRef.value.alipan_backup_folder ?? settingsDefaults.alipan_backup_folder,
    alipan_client_id: settingsRef.value.alipan_client_id ?? settingsDefaults.alipan_client_id,
    alipan_client_secret:
      settingsRef.value.alipan_client_secret ?? settingsDefaults.alipan_client_secret,
    alipan_enabled: (
      settingsRef.value.alipan_enabled ?? settingsDefaults.alipan_enabled
    ).toString(),
    alipan_last_backup_time:
      settingsRef.value.alipan_last_backup_time ?? settingsDefaults.alipan_last_backup_time,
    alipan_last_restore_time:
      settingsRef.value.alipan_last_restore_time ?? settingsDefaults.alipan_last_restore_time,
    alipan_refresh_token:
      settingsRef.value.alipan_refresh_token ?? settingsDefaults.alipan_refresh_token,
    article_layout_mode:
      settingsRef.value.article_layout_mode ?? settingsDefaults.article_layout_mode,
    ...
    eagle_api_url: settingsRef.value.eagle_api_url ?? settingsDefaults.eagle_api_url,
    eagle_enabled: (settingsRef.value.eagle_enabled ?? settingsDefaults.eagle_enabled).toString(),
    eagle_folder_id: settingsRef.value.eagle_folder_id ?? settingsDefaults.eagle_folder_id,
    eagle_folder_name: settingsRef.value.eagle_folder_name ?? settingsDefaults.eagle_folder_name,
    eagle_include_feed_tag: (
      settingsRef.value.eagle_include_feed_tag ?? settingsDefaults.eagle_include_feed_tag
    ).toString(),
    eagle_max_batch_size: (
      settingsRef.value.eagle_max_batch_size ?? settingsDefaults.eagle_max_batch_size
    ).toString(),
    eagle_name_template:
      settingsRef.value.eagle_name_template ?? settingsDefaults.eagle_name_template,
    eagle_tags: settingsRef.value.eagle_tags ?? settingsDefaults.eagle_tags,
    eagle_timeout_seconds: (
      settingsRef.value.eagle_timeout_seconds ?? settingsDefaults.eagle_timeout_seconds
    ).toString(),
    ...
    webdav_enabled: (
      settingsRef.value.webdav_enabled ?? settingsDefaults.webdav_enabled
    ).toString(),
    webdav_last_sync_time:
      settingsRef.value.webdav_last_sync_time ?? settingsDefaults.webdav_last_sync_time,
    webdav_password: settingsRef.value.webdav_password ?? settingsDefaults.webdav_password,
    webdav_remote_path: settingsRef.value.webdav_remote_path ?? settingsDefaults.webdav_remote_path,
    webdav_url: settingsRef.value.webdav_url ?? settingsDefaults.webdav_url,
    webdav_username: settingsRef.value.webdav_username ?? settingsDefaults.webdav_username,
  };
}
