...
export function parseSettingsData(data: Record<string, string>): SettingsData {
  return {
    ...
    alipan_last_backup_time: data.alipan_last_backup_time || settingsDefaults.alipan_last_backup_time,
    alipan_last_restore_time: data.alipan_last_restore_time || settingsDefaults.alipan_last_restore_time,
...
export function buildAutoSavePayload(settingsRef: Ref<SettingsData>): Record<string, string> {
  return {
    ...
    alipan_backup_filename: settingsRef.value.alipan_backup_filename ?? settingsDefaults.alipan_backup_filename,
    alipan_backup_folder: settingsRef.value.alipan_backup_folder ?? settingsDefaults.alipan_backup_folder,
    alipan_client_id: settingsRef.value.alipan_client_id ?? settingsDefaults.alipan_client_id,
    alipan_client_secret: settingsRef.value.alipan_client_secret ?? settingsDefaults.alipan_client_secret,
    alipan_enabled: (settingsRef.value.alipan_enabled ?? settingsDefaults.alipan_enabled).toString(),
    alipan_last_backup_time: settingsRef.value.alipan_last_backup_time ?? settingsDefaults.alipan_last_backup_time,
    alipan_last_restore_time: settingsRef.value.alipan_last_restore_time ?? settingsDefaults.alipan_last_restore_time,
    alipan_refresh_token: settingsRef.value.alipan_refresh_token ?? settingsDefaults.alipan_refresh_token,
    article_layout_mode: settingsRef.value.article_layout_mode ?? settingsDefaults.article_layout_mode,
    ...
    webdav_enabled: (settingsRef.value.webdav_enabled ?? settingsDefaults.webdav_enabled).toString(),
    webdav_last_sync_time: settingsRef.value.webdav_last_sync_time ?? settingsDefaults.webdav_last_sync_time,
