...
const zh: TranslationMessages = {
  ...
  common: {
    ...
    contextMenu: {
      ...
      downloadImage: '下载图片',
      saveAllImagesToEagle: '全部保存到 Eagle',
      saveImageToEagle: '保存图片到 Eagle',
    },
    copy: '复制',
    delete: '删除',
    done: '完成',
    ...
    toast: {
      ...
      downloadFailed: '下载失败',
      noImagesToSave: '没有可保存的图片',
      savedToEagle: '已保存 {count} 张图片到 Eagle',
      savedToEaglePartial: '已保存 {success}/{total} 张图片到 Eagle',
      saveToEagleFailed: '保存到 Eagle 失败',
      savingToEagle: '正在保存到 Eagle...',
    },
    pagination: {
      deleting: '删除中',
      loading: '加载中',
  ...
  modal: {
    ...
    discovery: {
      aiRankingFeeds: '正在验证推荐网站的 RSS',
      analyzingFeed: '正在分析当前订阅源',
      detecting: '检测中...',
      ...
      failedCandidateReason: '原因',
      failedCandidatesCount: '失败候选（{count}）',
      failedCandidateStage: '阶段',
      attemptedURLs: '尝试的 URL',
      detectedFeedURL: '检测到的 Feed URL',
      findingSimilarFeeds: 'AI 正在生成相似网站',
      noFeedsDiscovered: '未发现订阅源',
      noFriendLinksFound: '未找到友链',
      noRecommendedFeeds: '未推荐到相似订阅源',
      pleaseSelectFeeds: '请选择订阅源',
      preparingDiscovery: '准备发现',
      processingFeed: '正在处理订阅源 {current}/{total}',
      recommendFeeds: '推荐相似订阅源',
      recommendationAiGenerationFailed: 'AI 未能生成可用的网站推荐结果',
      recommendationAiNotConfigured: '尚未配置 AI 推荐功能',
      recommendationFeedNotFound: '未找到所选订阅源',
      recommendationInvalidCandidates: 'AI 返回的网站候选不可用',
      recommendationValidationFailed: '验证推荐网站的 RSS 失败',
      recommendationValidationTimedOut: '验证推荐网站 RSS 时超时',
    ...
    feed: {
      ...
      cleanupArticlesTitle: '清理文章',
      cleanupArticlesMessage: '确定要删除 "{name}" 中的所有文章吗？此操作无法撤销。',
      articlesCleanedSuccess: '已清理 {count} 篇文章',
      cleanupArticlesFailed: '清理文章失败',
      ...
      typeXPath: 'XPath',
      useRSSHubMode: '使用 RSSHub 模式（自动添加 rsshub:// 前缀）',
      rsshubPathPlaceholder: '例如：twitter/user/DIYgod',
      switchToRSSHub: '切换到 RSSHub',
      clickToSwitchNormal: '点击切换回普通模式',
      rsshubEditHint: '编辑 RSSHub 路由路径（例如：twitter/user/DIYgod）',
      xpath: 'XPath 支持',
  ...
  setting: {
    ...
    feed: {
      ...
      disableImageMode: '取消图片模式',
      enableFullTextFetch: '启用全文提取',
      enableFullTextFetchDesc: '当 RSS 仅提供摘要时，允许从原始网站提取完整文章内容',
      enableImageMode: '启用图片模式',
      fixedInterval: '固定间隔',
      imageMode: '图片模式',
      imageModeDesc: '以图片库视图而非文章列表展示此订阅源',
      videoMode: '视频模式',
      videoModeDesc: '将订阅源显示为视频模式',
      timelineMode: '时间线模式',
      timelineModeDesc: '仅在时间线模式中启用的订阅源会显示在时间线视图中',
    ...
    webdav: {
      enabled: 'WebDAV 订阅同步',
      enabledDesc: '通过 WebDAV 托管的 OPML 文件同步本地订阅列表',
      serverUrl: '服务器地址',
      serverUrlDesc: 'WebDAV 服务的基础端点 URL',
      serverUrlPlaceholder: 'https://dav.example.com/remote.php/dav/files/username',
      username: '用户名',
      usernameDesc: '用于 WebDAV 认证的用户名',
      usernamePlaceholder: '输入用户名',
      password: '密码',
      passwordDesc: '用于 WebDAV 认证的密码或应用专用密码',
      passwordPlaceholder: '输入密码',
      remotePath: '远程路径',
      remotePathDesc: '远程 OPML 文件路径。若填写目录，将自动使用 subscriptions.opml',
      remotePathPlaceholder: '/MrRSS/subscriptions.opml',
      syncNow: '同步订阅列表',
      syncNowDesc: '先把远程订阅合并到本地，再把合并后的 OPML 回写到 WebDAV',
      sync: '立即同步',
      syncing: '同步中...',
      syncFailed: 'WebDAV 订阅同步失败',
      syncSuccess: 'WebDAV 同步完成：导入 {imported} 个，导出 {exported} 个',
      invalidServerUrl: '请输入有效的 http(s) WebDAV 地址',
      validationFailed: '请先完整填写必需的 WebDAV 配置',
      lastSync: '上次同步',
      never: '从未',
      justNow: '刚刚',
      minsAgo: '{count} 分钟前',
    ...
    alipan: {
      enabled: '阿里云盘备份',
      enabledDesc: '通过阿里云盘备份和恢复本地 RSS 订阅列表',
      account: '阿里云盘账号',
      connectedDesc: '账号已连接，可使用备份与恢复。',
      disconnectedDesc: '请先连接阿里云盘账号后再使用同步。',
      builtinNotConfigured:
        '内置阿里云盘应用尚未配置，请先设置 MRRSS_ALIPAN_CLIENT_ID 和 MRRSS_ALIPAN_CLIENT_SECRET。',
      connect: '连接账号',
      connecting: '连接中...',
      connectStarted: '已打开浏览器，请完成授权后返回此页面。',
      connectSuccess: '阿里云盘连接成功',
      connectFailed: '发起授权失败',
      disconnect: '断开连接',
      disconnecting: '断开中...',
      disconnectConfirm: '确定要断开当前阿里云盘账号吗？',
      disconnectSuccess: '阿里云盘已断开',
      disconnectFailed: '断开连接失败',
      iHaveConnected: '我已完成授权',
      clientId: 'Client ID',
      clientIdDesc: '阿里云盘开放平台应用的 Client ID',
      clientIdPlaceholder: '请输入 Client ID',
      clientSecret: 'Client Secret',
      clientSecretDesc: '阿里云盘开放平台应用的 Client Secret',
      clientSecretPlaceholder: '请输入 Client Secret',
      refreshToken: 'Refresh Token',
      refreshTokenDesc: '用于阿里云盘授权的长期 Refresh Token',
      refreshTokenPlaceholder: '请输入 Refresh Token',
      backupFolder: '备份目录',
      backupFolderDesc: '阿里云盘中用于存放备份文件的目录路径',
      backupFolderPlaceholder: 'MrRSS',
      backupFilename: '备份文件名',
      backupFilenameDesc: '用于跨阅读器通用备份的 OPML 文件名',
      backupFilenamePlaceholder: 'subscriptions.opml',
      backupNow: '立即备份',
      backupNowDesc: '将当前本地订阅列表上传到阿里云盘',
      backup: '开始备份',
      backingUp: '备份中...',
      backupSuccess: '备份完成',
      backupFailed: '备份失败',
      restoreNow: '立即恢复',
      restoreNowDesc: '从阿里云盘下载备份并替换本地订阅列表',
      restore: '开始恢复',
      restoring: '恢复中...',
      restoreSuccess: '恢复完成',
      restoreFailed: '恢复失败',
      restoreConfirm:
        '恢复会用备份替换本地订阅列表（未包含在备份中的本地订阅将被删除），是否继续？',
      lastBackup: '上次备份',
      lastRestore: '上次恢复',
    },
    plugins: {
      eagle: {
        apiUrl: 'API 地址',
        apiUrlDesc: 'Eagle 本地 HTTP API 地址，通常保持默认即可。',
        connectionFailed: '连接 Eagle 失败',
        connectionSuccessful: 'Eagle 连接成功',
        folder: '默认文件夹',
        folderDesc: '选择图片保存位置。留空则保存到 Eagle 默认位置。',
        foldersLoaded: 'Eagle 文件夹已加载',
        foldersLoadFailed: '加载 Eagle 文件夹失败',
        includeFeedTag: '添加订阅源标签',
        includeFeedTagDesc: '自动将订阅源名称添加为 Eagle 标签。',
        info: '保存图片或加载文件夹前，请确保 Eagle 正在运行。',
        integration: 'Eagle 集成',
        integrationDescription: '直接将文章图片保存到 Eagle',
        maxBatchSize: '批量上限',
        maxBatchSizeDesc: '一次批量保存的最大图片数量。',
        nameTemplate: '命名模板',
        nameTemplateDesc: '可用变量：{title}、{feed}、{index}、{date}、{timestamp}。',
        noFolder: '不选择文件夹',
        refreshFolders: '刷新文件夹',
        tags: '默认标签',
        tagsDesc: '用逗号分隔，每张保存的图片都会添加这些 Eagle 标签。',
        testConnection: '测试连接',
        testConnectionDesc: '验证 MrRSS 是否能连接 Eagle API。',
        testing: '测试中...',
        timeout: '超时时间',
        timeoutDesc: '每张图片下载和调用 Eagle 的超时时间。',
      },
      obsidian: {
