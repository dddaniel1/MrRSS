...
failedCandidateReason: 'Reason',
    ...
    feed: {
      ...
      cleanupArticlesMessage: 'Are you sure you want to delete all articles from "{name}"? This action cannot be undone.',
  ...
  setting: {
    ...
    webdav: {
      ...
      syncNowDesc: 'Merge remote subscriptions into local data, then upload the merged OPML back to WebDAV',
      sync: 'Sync Now',
      syncing: 'Syncing...',
