...
const en: TranslationMessages = {
  article: {
    action: {
      ...
      cleanupArticles: 'Cleanup Articles',
  ...
  common: {
    ...
    contextMenu: {
      ...
      saveAllImagesToEagle: 'Save All Images to Eagle',
      saveImageToEagle: 'Save Image to Eagle',
    },
    copy: 'Copy',
    delete: 'Delete',
    done: 'Done',
    ...
    toast: {
      ...
      noImagesToSave: 'No images to save',
      savedToEagle: 'Saved {count} image(s) to Eagle',
      savedToEaglePartial: 'Saved {success}/{total} image(s) to Eagle',
      saveToEagleFailed: 'Failed to save to Eagle',
      savingToEagle: 'Saving to Eagle...',
    },
    pagination: {
      deleting: 'Deleting',
      loading: 'Loading',
  ...
  modal: {
    ...
    discovery: {
      aiRankingFeeds: 'Validating recommended websites for RSS',
      analyzingFeed: 'Analyzing current feed',
      detecting: 'Detecting...',
      ...
      failedCandidateReason: 'Reason',
      failedCandidatesCount: 'Failed candidates ({count})',
      failedCandidateStage: 'Stage',
      attemptedURLs: 'Attempted URLs',
      detectedFeedURL: 'Detected feed URL',
      findingSimilarFeeds: 'Generating similar websites with AI',
      noFeedsDiscovered: 'No feeds discovered',
      noFriendLinksFound: 'No friend links found',
      noRecommendedFeeds: 'No similar feeds recommended',
      pleaseSelectFeeds: 'Please select feeds',
      preparingDiscovery: 'Preparing discovery',
      processingFeed: 'Processing feed {current}/{total}',
      recommendFeeds: 'Recommend Similar Feeds',
      recommendationAiGenerationFailed: 'AI failed to generate usable website recommendations',
      recommendationAiNotConfigured: 'AI recommendation is not configured yet',
      recommendationFeedNotFound: 'The selected feed could not be found',
      recommendationInvalidCandidates: 'AI returned unusable website candidates',
      recommendationValidationFailed: 'Failed to validate recommended websites for RSS',
      recommendationValidationTimedOut: 'Timed out while validating recommended websites',
    ...
    feed: {
      ...
      cleanupArticlesTitle: 'Cleanup Articles',
      cleanupArticlesMessage:
        'Are you sure you want to delete all articles from "{name}"? This action cannot be undone.',
      articlesCleanedSuccess: 'Cleaned up {count} articles',
      cleanupArticlesFailed: 'Failed to cleanup articles',
      ...
      categoryRefreshStarted: 'Category refresh started',
      ...
      typeXPath: 'XPath',
      useRSSHubMode: 'Use RSSHub Mode (auto-add rsshub:// prefix)',
      rsshubPathPlaceholder: 'e.g. twitter/user/DIYgod',
      switchToRSSHub: 'Switch to RSSHub',
      clickToSwitchNormal: 'Click to switch back',
      rsshubEditHint: 'Edit the RSSHub route path (e.g., twitter/user/DIYgod)',
      xpath: 'XPath Support',
  ...
  setting: {
    ...
    feed: {
      ...
      videoModeDesc: 'Show this feed in video mode',
      timelineMode: 'Timeline Mode',
      timelineModeDesc: 'Only feeds enabled for timeline mode appear in Timeline view',
    ...
    webdav: {
      enabled: 'WebDAV Subscription Sync',
      enabledDesc: 'Synchronize local subscriptions with a WebDAV-hosted OPML file',
      serverUrl: 'Server URL',
      serverUrlDesc: 'Base WebDAV endpoint URL',
      serverUrlPlaceholder: 'https://dav.example.com/remote.php/dav/files/username',
      username: 'Username',
      usernameDesc: 'Username used for WebDAV authentication',
      usernamePlaceholder: 'Enter your username',
      password: 'Password',
      passwordDesc: 'Password or app password used for WebDAV authentication',
      passwordPlaceholder: 'Enter your password',
      remotePath: 'Remote Path',
      remotePathDesc: 'Remote OPML file path. Folder paths automatically use subscriptions.opml',
      remotePathPlaceholder: '/MrRSS/subscriptions.opml',
      syncNow: 'Sync Subscriptions',
      syncNowDesc:
        'Merge remote subscriptions into local data, then upload the merged OPML back to WebDAV',
      sync: 'Sync Now',
      syncing: 'Syncing...',
      syncFailed: 'WebDAV subscription sync failed',
      syncSuccess: 'WebDAV sync complete: imported {imported}, exported {exported}',
      invalidServerUrl: 'Enter a valid http(s) WebDAV URL',
      validationFailed: 'Please complete the required WebDAV settings first',
      lastSync: 'Last Sync',
      never: 'Never',
      justNow: 'Just now',
      minsAgo: '{count} minutes ago',
    ...
    alipan: {
      enabled: 'Aliyun Drive Backup',
      enabledDesc: 'Backup and restore local RSS subscriptions through Aliyun Drive',
      account: 'Aliyun Drive Account',
      connectedDesc: 'Account connected. Backup and restore are available.',
      disconnectedDesc: 'Connect your Aliyun Drive account to enable sync.',
      builtinNotConfigured:
        'Built-in Aliyun app is not configured yet. Please set MRRSS_ALIPAN_CLIENT_ID and MRRSS_ALIPAN_CLIENT_SECRET.',
      connect: 'Connect',
      connecting: 'Connecting...',
      connectStarted: 'Browser opened. Complete authorization, then return here.',
      connectSuccess: 'Aliyun Drive connected',
      connectFailed: 'Failed to start authorization',
      disconnect: 'Disconnect',
      disconnecting: 'Disconnecting...',
      disconnectConfirm: 'Disconnect this Aliyun Drive account from MrRSS?',
      disconnectSuccess: 'Aliyun Drive disconnected',
      disconnectFailed: 'Failed to disconnect account',
      iHaveConnected: 'I Have Connected',
      clientId: 'Client ID',
      clientIdDesc: 'App client ID from Aliyun Drive Open Platform',
      clientIdPlaceholder: 'Enter your client ID',
      clientSecret: 'Client Secret',
      clientSecretDesc: 'App client secret from Aliyun Drive Open Platform',
      clientSecretPlaceholder: 'Enter your client secret',
      refreshToken: 'Refresh Token',
      refreshTokenDesc: 'Long-lived refresh token for Aliyun Drive authorization',
      refreshTokenPlaceholder: 'Enter your refresh token',
      backupFolder: 'Backup Folder',
      backupFolderDesc: 'Folder path in Aliyun Drive to store backup files',
      backupFolderPlaceholder: 'MrRSS',
      backupFilename: 'Backup File Name',
      backupFilenameDesc: 'OPML file name for cross-reader subscription backup',
      backupFilenamePlaceholder: 'subscriptions.opml',
      backupNow: 'Backup Now',
      backupNowDesc: 'Upload current local subscription list to Aliyun Drive',
      backup: 'Backup',
      backingUp: 'Backing up...',
      backupSuccess: 'Backup completed',
      backupFailed: 'Backup failed',
      restoreNow: 'Restore Now',
      restoreNowDesc: 'Download backup from Aliyun Drive and replace local subscription list',
      restore: 'Restore',
      restoring: 'Restoring...',
      restoreSuccess: 'Restore completed',
      restoreFailed: 'Restore failed',
      restoreConfirm:
        'Restore will replace your local subscription list with the backup (non-backed-up local subscriptions will be removed). Continue?',
    ...
    plugins: {
      eagle: {
        apiUrl: 'API URL',
        apiUrlDesc: 'Local Eagle HTTP API address. The default is usually correct.',
        connectionFailed: 'Failed to connect to Eagle',
        connectionSuccessful: 'Eagle connection successful',
        folder: 'Default Folder',
        folderDesc: 'Choose where images are saved. Leave empty to use Eagle default location.',
        foldersLoaded: 'Eagle folders loaded',
        foldersLoadFailed: 'Failed to load Eagle folders',
        includeFeedTag: 'Add Feed Tag',
        includeFeedTagDesc: 'Automatically add the feed title as an Eagle tag.',
        info: 'Keep Eagle running before saving images or loading folders.',
        integration: 'Eagle Integration',
        integrationDescription: 'Save article images directly to Eagle',
        maxBatchSize: 'Batch Limit',
        maxBatchSizeDesc: 'Maximum number of images saved in one batch.',
        nameTemplate: 'Name Template',
        nameTemplateDesc: 'Available variables: {title}, {feed}, {index}, {date}, {timestamp}.',
        noFolder: 'No folder selected',
        refreshFolders: 'Refresh Folders',
        tags: 'Default Tags',
        tagsDesc: 'Comma-separated Eagle tags added to every saved image.',
        testConnection: 'Test Connection',
        testConnectionDesc: 'Verify that MrRSS can connect to the Eagle API.',
        testing: 'Testing...',
        timeout: 'Timeout',
        timeoutDesc: 'Timeout for downloading each image and calling Eagle.',
      },
      obsidian: {
