...
type Defaults struct {
	...
	EagleEnabled                  bool   `json:"eagle_enabled"`
	EagleFolderId                 string `json:"eagle_folder_id"`
	EagleFolderName               string `json:"eagle_folder_name"`
	EagleIncludeFeedTag           bool   `json:"eagle_include_feed_tag"`
	EagleMaxBatchSize             int    `json:"eagle_max_batch_size"`
	EagleNameTemplate             string `json:"eagle_name_template"`
	EagleTags                     string `json:"eagle_tags"`
	EagleTimeoutSeconds           int    `json:"eagle_timeout_seconds"`
...
func GetString(key string) string {
	...
	case "eagle_api_url":
		return defaults.EagleAPIUrl
	case "eagle_enabled":
		return strconv.FormatBool(defaults.EagleEnabled)
	case "eagle_folder_id":
		return defaults.EagleFolderId
	case "eagle_folder_name":
		return defaults.EagleFolderName
	case "eagle_include_feed_tag":
		return strconv.FormatBool(defaults.EagleIncludeFeedTag)
	case "eagle_max_batch_size":
		return strconv.Itoa(defaults.EagleMaxBatchSize)
	case "eagle_name_template":
		return defaults.EagleNameTemplate
	case "eagle_tags":
		return defaults.EagleTags
	case "eagle_timeout_seconds":
		return strconv.Itoa(defaults.EagleTimeoutSeconds)
